...
declare -A SERVICE_VARS=(
  ["chat-orch"]="OPENROUTER_API_KEY OPENAI_BASE_URL OPENAI_DEFAULT_MODEL CONVERSATION_CHAT_URL TENANT_SERVICE_URL METRICAS_URL HOSPITAL_MOCK_URL AGENT_RUNTIME_URL CORS_ALLOW_ORIGIN TELEGRAM_BOT_TOKEN TELEGRAM_DEFAULT_TENANT_ID TWILIO_ACCOUNT_SID TWILIO_AUTH_TOKEN TWILIO_API_KEY_SID TWILIO_API_KEY_SECRET TWILIO_TWIML_APP_SID TWILIO_DEFAULT_TENANT_ID BACKEND_CHANNEL_KEY BACKEND_CHANNEL_ENABLED"
  ["tenant"]="DATABASE_URL JWT_SECRET"
  ["conversation-chat"]="MONGO_URI MONGO_DB REDIS_URL RABBITMQ_URL ACR_SERVICE_URL TENANT_SERVICE_URL AUTH_SERVICE_URL OPENROUTER_API_KEY OPENAI_BASE_URL OPENAI_DEFAULT_MODEL BACKEND_CHANNEL_KEY BACKEND_CHANNEL_ENABLED"
  ["agent-runtime"]="CONVERSATION_CHAT_URL HOSPITAL_MOCK_URL OPENAI_BASE_URL OPENAI_DEFAULT_MODEL RABBITMQ_URL BACKEND_CHANNEL_KEY BACKEND_CHANNEL_ENABLED"
